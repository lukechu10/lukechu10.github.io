...
> This is a self-guided blog post. Click on _Next_ to continue to the next section. Certain sections also have red links that you can click on to play the corresponding animation.

> It is also recommended that you view this on a tablet, laptop, or monitor for the best experience.
